...
# File
AmFall_Github.m : MATLAB (R2024a) code for preprocessing of CSI log file (to generate image file). CSI tool (https://dhalperi.github.io/linux-80211n-csitool/) should be preinstalled to execuit it.
