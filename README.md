...
# Files
  - AmFall_Github.m : MATLAB code for preprocessing of CSI log file (to generate image file). CSI tool (https://dhalperi.github.io/linux-80211n-csitool/) should be preinstalled to execuit it.
